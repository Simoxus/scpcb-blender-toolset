        ...
        while token != None and self.text_brace_count >= brace_count:
            if brace_count == self.text_brace_count:
                if token == "FrameTransformMatrix":
                    ...
                    r0 = self.get_next_float_text()
                    r1 = self.get_next_float_text()
                    r2 = self.get_next_float_text()
                    o0 = self.get_next_float_text()
                    r3 = self.get_next_float_text()
                    r4 = self.get_next_float_text()
                    r5 = self.get_next_float_text()
                    o1 = self.get_next_float_text()
                    r6 = self.get_next_float_text()
                    r7 = self.get_next_float_text()
                    r8 = self.get_next_float_text()
                    o2 = self.get_next_float_text()
                    t0 = self.get_next_float_text()
                    t1 = self.get_next_float_text()
                    t2 = self.get_next_float_text()
                    o3 = self.get_next_float_text()
